    ...
    if (ISLOGIN && SESSION_TOKEN) {
        WeakObj(self);
          ...
          [self loadMyUserInfoWithOkBlock:^(BOOL isOk) {
            ...
            selfWeak.headerView.model = [LxmTool ShareTool].userModel;
            selfWeak.navView.infoMode = [LxmTool ShareTool].userModel;
    ...
    if (ISLOGIN && SESSION_TOKEN) {
        LTSCRefreshHeader *header = [LTSCRefreshHeader headerWithRefreshingBlock:^{
             [self loadMyUserInfoWithOkBlock:^(BOOL isOk) {
                ...
                [self endRefrish];
                self.headerView.model = [LxmTool ShareTool].userModel;
                self.navView.infoMode = [LxmTool ShareTool].userModel;
            }];
        }];
...
//                vc.hidesBottomBarWhenPushed = YES;
//                vc.nick_nameStr = [LxmTool ShareTool].userModel.username;
//                vc.sex = [LxmTool ShareTool].userModel.sex;
//                [self.navigationController pushViewController:vc animated:YES];
//                
//            } else {
//                
