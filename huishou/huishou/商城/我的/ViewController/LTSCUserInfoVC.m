...
- (UIImageView *)userImgView {
    if (!_userImgView) {
        ...
        [_userImgView sd_setImageWithURL:[NSURL URLWithString:[LxmTool ShareTool].userModel.head_pic] placeholderImage:[UIImage imageNamed:@"scpeople"]];
...
- (LTSCNickView *)nickView {
    if (!_nickView) {
        ...
        _nickView.nickTF.text = [LxmTool ShareTool].userModel.username;
    }
    return _nickView;
}
...
- (LTSCSexView *)sexView {
    if (!_sexView) {
        ...
        _sexView.userModel = [LxmTool ShareTool].userModel;
    }
    return _sexView;
}
...
//        _nameView.nickTF.text = [LxmTool ShareTool].userModel.nickname;
    }
    return _nameView;
}
...
//        _qiyeNameView.nickTF.text = [LxmTool ShareTool].userModel.comName;
    }
...
//        _yyzzView.nickTF.text = [LxmTool ShareTool].userModel.licenseNo;
    }
    return _yyzzView;
}
...
//        [_imgView sd_setImageWithURL:[NSURL URLWithString:[LxmTool ShareTool].userModel.licensePic] placeholderImage:[UIImage imageNamed:@"paizhao"]];
...
//        _shuihaoView.nickTF.text = [LxmTool ShareTool].userModel.taxNo;
    }
    return _shuihaoView;
}
