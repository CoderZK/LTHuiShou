...
- (void)sendCode {
    ...
    [dict setObject:[LxmTool ShareTool].userModel.telephone forKey:@"telephone"];
...
- (void)oneStep {
    ...
    dict[@"telephone"] = [LxmTool ShareTool].userModel.telephone;
...
- (UITextField *)phoneTF {
    if (!_phoneTF) {
        ...
        if ([LxmTool ShareTool].userModel.tel) {
            NSString *str = [NSString stringWithFormat:@"%@",[LxmTool ShareTool].userModel.telephone];
