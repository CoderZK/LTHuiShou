...
- (void)setInfoMode:(LxmUserInfoModel *)infoMode {
    _infoMode = infoMode;
    if (_infoMode.head_pic && ![_infoMode.head_pic isKong]) {
        [_userImgView sd_setImageWithURL:[NSURL URLWithString:_infoMode.head_pic] placeholderImage:[UIImage imageNamed:@"scpeople"]];
    } else {
        _userImgView.image = [UIImage imageNamed:@"scpeople"];
    }
    ...
    if (self) {
        ...
        for (int i = 0; i < 5; i ++) {
            ...
            if (i == 0) {
                ...
                btn.iconImgView.image = [UIImage imageNamed:@"dfh-1"];
