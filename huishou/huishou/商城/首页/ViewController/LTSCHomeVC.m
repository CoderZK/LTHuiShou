...
//        [selfWeaktabBarController.tabBar layoutIfNeeded];
    ...
    [[self.titleView.goBackBt rac_signalForControlEvents:UIControlEventTouchUpInside] subscribeNext:^(__kindof UIControl * _Nullable x) {
        LxmTabBarVC * tabr = [[LxmTabBarVC alloc] init];
        [UIApplication sharedApplication].keyWindow.rootViewController = tabr;
    }];
