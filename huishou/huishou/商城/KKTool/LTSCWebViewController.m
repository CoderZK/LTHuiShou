...
@interface LTSCWebViewController ()<WKNavigationDelegate,WKScriptMessageHandler>
{
...
@implementation LTSCWebViewController
...
-(void)viewWillDisappear:(BOOL)animated {
    ...
    [LTSCEventBus sendEvent:@"seeAllready" data:nil];
    [LTSCEventBus sendEvent:@"singCompleted" data:nil];
    if (_progress) {
...
- (void)viewDidLoad {
    ...
    //修改进度条颜色
    _progress.progressTintColor = MineColor;
    _progress.trackTintColor = MineColor;
