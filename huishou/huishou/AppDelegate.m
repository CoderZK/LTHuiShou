...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [LTSCEventBus registerEvent:@"goback" block:^(id data) {
        UIViewController * tab = [UIApplication sharedApplication].keyWindow.rootViewController;
        if ([tab isKindOfClass:[LxmTabBarVC class]] || [tab isKindOfClass:[LTSCTabBarVC class]] || [tab isKindOfClass:[LTSCDianPuTabBarController class]]) {
            BaseNavigationController * navc = [(UITabBarController *)tab selectedViewController];
