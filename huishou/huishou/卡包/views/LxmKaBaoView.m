...
@implementation LxmKaBaoView


@end
@interface LxmKaBaoHeaderView ()

@end
@implementation LxmKaBaoHeaderView
...
- (UILabel *)moreLabel {
    if (!_moreLabel) {
        ...
        _moreLabel.textColor = [UIColor colorWithRed:252/255.0 green:87/255.0 blue:91/255.0 alpha:1.0];
...
@end
@implementation LxmKaBaoCardCell
...
- (UILabel *)moreLabel {
    if (!_moreLabel) {
        _moreLabel = [UILabel new];
        _moreLabel.backgroundColor = [UIColor colorWithRed:252/255.0 green:87/255.0 blue:91/255.0 alpha:1.0];
...
@interface LxmKaBaoEmptyCell ()

@property (nonatomic, strong) LxmEmptyView *emptyView;//空界面

@end
@implementation LxmKaBaoEmptyCell
...
@end
@implementation LxmKaDetailView
...
- (UIView *)cardImgView {
    if (!_cardImgView) {
        ...
        _cardImgView.image = [UIImage imageNamed:@"banner"];
...
@implementation LxmKaDetailheaderView
...
- (UILabel *)textLabel1 {
    if (!_textLabel1) {
        ...
        _textLabel1.textColor = [UIColor colorWithRed:252/255.0 green:87/255.0 blue:91/255.0 alpha:1.0];
...
@end
@implementation LxmKaDetailCell
...
@interface LxmMoneyCell ()

@end
@implementation LxmMoneyCell
...
@interface LxmKaDetailMoneyCell ()<UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
@end
@implementation LxmKaDetailMoneyCell
...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        ...
        [_collectionView registerClass:LxmMoneyCell.class forCellWithReuseIdentifier:@"LxmMoneyCell"];
    }
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    LxmMoneyCell *itemCell = [collectionView dequeueReusableCellWithReuseIdentifier:@"LxmMoneyCell" forIndexPath:indexPath];
    itemCell.titleLabel.text = @"50";
    itemCell.titleLabel.layer.borderColor = indexPath.item == self.currentIndex ? [UIColor colorWithRed:252/255.0 green:76/255.0 blue:81/255.0 alpha:1.0].CGColor : [UIColor colorWithRed:220/255.0 green:220/255.0 blue:220/255.0 alpha:1.0].CGColor;
    itemCell.titleLabel.textColor = indexPath.item == self.currentIndex ? [UIColor colorWithRed:252/255.0 green:76/255.0 blue:81/255.0 alpha:1.0] : [UIColor colorWithRed:34/255.0 green:34/255.0 blue:34/255.0 alpha:1.0];
...
@interface LxmKaDetailBottomView ()
...
@end
@implementation LxmKaDetailBottomView
...
- (UIButton *)sureKaiTongButton {
    if (!_sureKaiTongButton) {
        ...
        [_sureKaiTongButton setBackgroundImage:[UIImage imageNamed:@"red"] forState:UIControlStateNormal];
...
@interface LxmKaDetailMingXiView ()

@property (nonatomic, strong) UIView *bgView;

@property (nonatomic, strong) LxmMingXiView *chongzhiView;

@property (nonatomic, strong) LxmMingXiView *kaikaView;

@end
@implementation LxmKaDetailMingXiView
...
- (LxmMingXiView *)chongzhiView {
    if (!_chongzhiView) {
        _chongzhiView = [LxmMingXiView new];
...
- (LxmMingXiView *)kaikaView {
    if (!_kaikaView) {
        _kaikaView = [LxmMingXiView new];
...
//已开卡详情
@implementation LxmYiKaiKaGongNengButton
...
@interface LxmYiKaiKaGongNengCell ()

@end
@implementation LxmYiKaiKaGongNengCell
...
- (LxmYiKaiKaGongNengButton *)shukaButton {
    if (!_shukaButton) {
        _shukaButton = [LxmYiKaiKaGongNengButton new];
...
- (LxmYiKaiKaGongNengButton *)chongzhiButton {
    if (!_chongzhiButton) {
        _chongzhiButton = [LxmYiKaiKaGongNengButton new];
...
- (LxmYiKaiKaGongNengButton *)setMorenButton {
    if (!_setMorenButton) {
        _setMorenButton = [LxmYiKaiKaGongNengButton new];
...
@implementation LxmChongZhiCell
